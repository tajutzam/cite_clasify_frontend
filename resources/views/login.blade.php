...
<head>
    <title>CiteClasify Klasifikasi Sitasi Journal-</title>
            ...
            <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative"
                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        ...
                        <p class="fw-bold fs-2" style="color: #986923;">Ukur Kualitas Journal Kamu
                            <br />dengan bantuan Machine learning
                        </p>
                    </div>
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                            ...
                            <div class="text-center mb-10">
                                <!--begin::Title-->
                                <h1 class="text-dark mb-3">Sign In to Cite Clasify</h1>
                                <!--end::Title-->
                                <!--begin::Link-->
